...
/**
 * Commande qui a pour but de faire un "zoom in" sur l'image. En d'autres termes, elle permet à l'utilisateur
 * d'agrandir une instance de l'image connectée à sa perspective dans son panneau respectif.
 */
public class CommandeAgrandir extends Commande {
    ...
    public void executer(ModeleApplication modele) {
        ...
        // Selon la perspective de la souris actuelle, on agrandit l'image appropriée.
